...
## renpy_patches.rpy
# This file is mainly designed to patch certain versions of Ren'Py that break DDLC/DDLC mods by patching the Ren'Py engine at startup.
# Since this is Ren'Py 8/Py3 branch, some patches have been removed due tobeing obsolete.

# init -1 python:
#     ## Patches the Monika Space Room Effects however it might disable OpenGL 2 for some mods that use it. If you do use OpenGL 2,
