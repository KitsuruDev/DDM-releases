...
init -200:
    define gui.phone_margin = (15, 81, 15, 94) # корпус
    define gui.phone_zoom = 0.85
    define gui.phone_xsize = 389 # экран
...
python early:
    ...
    _rounded_corners_relative = { None: 0.0, "min": 1.0, "max": 2.0, "width": 3.0, "height": 4.0 }
    ...
    class CircleDisplayable(ShaderDisplayable):
        ...
        def render(self, w, h, st, at):
            radius = min(w, h) / 2.0 if self.radius is None else self.radius
