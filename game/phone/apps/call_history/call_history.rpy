screen phone_call_history():
    default call_history = phone.data[pov_key_mobile]["call_history"]
    ...
    use _phone():
        ...
        side "t c":
            use app_base():
                ...
                text _("История звонков") xalign 0.5 text_align 0.5 size 22

            if not call_history:
                text _("Список пуст") style "phone_call_history_empty" align (0.5, 0.05)
                                ...
                                button:
                                    ...
                                    hbox:
                                        ...
                                        fixed:
                                            ...
                                            text str(phone.format_date(*entry.date)):
